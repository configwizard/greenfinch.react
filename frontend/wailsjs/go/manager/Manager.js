...
export function MakeToast(arg1) {
  window['go']['manager']['Manager']['MakeToast'](arg1);
}
...
export function SetProgressPercentage(arg1) {
  window['go']['manager']['Manager']['SetProgressPercentage'](arg1);
}
...
export function ForceSync() {
  window['go']['manager']['Manager']['ForceSync']();
}
...
export function SendSignal(arg1, arg2) {
  window['go']['manager']['Manager']['SendSignal'](arg1, arg2);
}
...
export function MakeNotification(arg1) {
  window['go']['manager']['Manager']['MakeNotification'](arg1);
}
