export interface go {
  "manager": {
    "Manager": {
		AddContact(arg1:string,arg2:string,arg3:string,arg4:string):Promise<Array<contact>|Error>
		AddSharedContainer(arg1:string):Promise<Error>
		...
		DeleteContact(arg1:string):Promise<Array<contact>|Error>
		...
		ListSharedContainerObjects(arg1:string,arg2:boolean):Promise<Array<Element>|Error>
