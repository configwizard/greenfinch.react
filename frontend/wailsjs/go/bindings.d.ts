...
export interface go {
  ...
  "mocker": {
    "Mocker": {
		GetAccountInformation(arg1:string):Promise<models.Account|Error>
		ListContainerPopulatedObjects(arg1:string):Promise<Array<models.Element>|Error>
		ListContainers(arg1:string):Promise<Array<models.Element>|Error>
		Search(arg1:string,arg2:string):Promise<Array<models.Element>|Error>
    },
  }
