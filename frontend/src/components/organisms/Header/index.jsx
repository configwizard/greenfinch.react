                ...
                <header>
                    <div className="header-content d-flex">
                        ...
                        <div className="atmHeaderPower d-flex align-items-center justify-content-center">
                            {this.state.selectedNetwork.Name === "Test Net" ? <span className="testtest"><i className="mainnetOff fa-sharp fa-solid fa-power-off"/></span> : <span className="testmain"><i className="mainnetOff fa-sharp fa-solid fa-power-off"/></span> }
                        </div>
                        */}
